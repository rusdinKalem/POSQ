...
7. Jalankan server track S0-S12 saat masuk M7/M8/M9/M10.
8. Lanjutkan milestone satu per satu sampai M14.
9. Review security, backup, license, server, dan release readiness.
10. Build installer.
11. Pilot dengan data terbatas.
...
Implement:
- S0-001 Lock server architecture
- S1-001 Scaffold control-plane API
- S1-002 Scaffold worker
- S1-003 Scaffold admin dashboard
- S2-001 Server DB migrations
- S2-002 Server schema guardrail
- S3-001 Auth and tenant scope
- S4-001 Merchant/device activation
- S5-001 Subscription/entitlement
- S6-001 License issuer
- S7-001 Update metadata
...
- SERVER_TEST_PLAN.md: SRV/SDB/SAUTH/SLIC/SSUB/SUPD subset.
- Server schema guardrail test wajib lulus.
- Update docs/STATUS.md.
```

## 13A. Prompt 9A - Server Dashboard, Worker, and Deployment Track

```text
Lanjutkan server track setelah API dasar M7 berjalan.
...
Implement:
- S8-001 Backup metadata
- S9-001 Admin dashboard
- S10-001 Worker jobs
- S11-001 Server security review
- S12-001 Server deployment readiness

Batasan:
- Dashboard admin tidak boleh menjadi dashboard transaksi toko.
- Worker tidak boleh mengubah data transaksi local merchant.
- Backup metadata tidak boleh menyimpan payload database.
- Semua mutasi admin harus punya audit log.

Validasi:
- SERVER_TEST_PLAN.md semua P0.
- Tenant isolation lulus.
- Forbidden table guardrail lulus.
- Backup metadata idempotency lulus.
- Staging deploy dan server DB restore drill lulus.
- Update docs/STATUS.md.
```
...
9. Prompt 8 - M6.
10. Prompt 9 - M7.
11. Prompt 9A - Server Dashboard, Worker, and Deployment Track.
12. Prompt 10 - M8.
13. Prompt 11 - M9.
14. Prompt 12 - M10.
15. Prompt 13 - M11.
16. Prompt 14 - M12.
17. Prompt 15 - M13.
18. Prompt 16 - Security Review.
19. Prompt 17 - M14.
20. Prompt 18 - Pilot Readiness.
21. Prompt 19 - Final Release Readiness.
22. Prompt 20 - Finish.
